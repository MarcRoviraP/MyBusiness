...
class Theme0063D8 {
  ...
  const Theme0063D8(this.textTheme);
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onTertiaryContainer: Color(0xff583e5a),
      ...
      onTertiaryFixed: Color(0xff2a132d),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.light,
      primary: Color(0xff0c2a5b),
      surfaceTint: Color(0xff455e91),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff2f487a),
      onPrimaryContainer: Color(0xffffffff),
      secondary: Color(0xff252c3d),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff42495b),
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff3c233e),
      onTertiary: Color(0xffffffff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffdbb8da),
      onTertiaryContainer: Color(0xff17031b),
