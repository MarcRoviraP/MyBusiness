...
class Theme949CAE {
  ...
  const Theme949CAE(this.textTheme);
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff442e4b),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff7e6484),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff0b3261),
      onPrimaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryFixed: Color(0xfff9d8fe),
      onTertiaryFixed: Color(0xff1d0824),
      tertiaryFixedDim: Color(0xffdcbce1),
      onTertiaryFixedVariant: Color(0xff442e4b),
      surfaceDim: Color(0xff111318),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xffa5c4fb),
      ...
      tertiaryContainer: Color(0xffd8b8dd),
      ...
      tertiaryFixedDim: Color(0xffdcbce1),
      onTertiaryFixedVariant: Color(0xff1d0824),
      surfaceDim: Color(0xff111318),
