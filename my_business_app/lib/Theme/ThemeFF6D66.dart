...
class ThemeFF6D66 {
  ...
  const ThemeFF6D66(this.textTheme);
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff904a45),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xffa15853),
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff82693b),
      ...
      inverseSurface: Color(0xff392e2d),
      inversePrimary: Color(0xffffb3ad),
      primaryFixed: Color(0xffa15853),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff84413c),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff876562),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff6c4d4a),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff82693b),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff904a45),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff763632),
      onPrimaryContainer: Color(0xffffffff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffddbe89),
